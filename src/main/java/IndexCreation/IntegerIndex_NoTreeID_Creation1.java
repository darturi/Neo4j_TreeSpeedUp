...
public class IntegerIndex_NoTreeID_Creation1 implements AutoCloseable {

    private final Driver driver;
    private final String database;

    public IntegerIndex_NoTreeID_Creation1(String uri, String user, String password, String database) {
    ...
    public static void main(String[] args) {
        ...
        String user = "neo4j";
        String password = "giggleswirl";  // Change this to your actual password
        String database = "integer-no-tree-id.100k";
    ...
    public static void annotate_n_forest(String db_name, Integer tree_size, String uri, String user, String password, Integer n){
        try (IntegerIndex_NoTreeID_Creation1 app = new IntegerIndex_NoTreeID_Creation1(uri, user, password, db_name)) {
